...
<button onclick="deleteDeliverable(${task.id}, ${task.deliverable_id})"
   ...
   <button  onclick=viewDoc('${task.id}')
       class="flex items-center gap-1.5 text-xs px-4 font-semibold text-blue-500 dark:text-blue-400 border border-dashed border-blue-500 rounded-lg px-3 py-1.5 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors duration-200 active:bg-amber-700 active:scale-95">
       View Docs
     </button>
     </div>`: (currentUser?.role === "Faculty/File Incharge") ? ` <button  onclick=openUploadDocModal('${task.id}')
       class="flex items-center gap-1.5 w-full font-semibold  text-l px-4 font-semibold text-blue-500 dark:text-blue-400 border border-dashed border-blue-500 rounded-lg px-3 py-1.5 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors duration-200 active:bg-amber-700 active:scale-95">
